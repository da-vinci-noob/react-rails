  ...
  module Api
    class TokensController < Devise.api.config.base_controller.constantize
      ...
      def sign_up
        ...
        error_response = Devise::Api::Responses::ErrorResponse.new(
          request,
          resource_class: resource_class,
          **service.failure
        )
      ...
      def sign_in
        ...
        service = Devise::Api::ResourceOwnerService::SignIn.new(
        ...
        if service.success?
          ...
          token_response = Devise::Api::Responses::TokenResponse.new(
            request, token: service.success,
                     action: __method__
          )
      ...
      def info
        token_response = Devise::Api::Responses::TokenResponse.new(
          request, token: current_devise_api_token,
                   action: __method__
        )
        render json: token_response.resource_owner.as_json(include: :referred_users), status: token_response.status
      end
